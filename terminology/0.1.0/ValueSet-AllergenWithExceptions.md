# eHDSI Agent or Allergen With Exceptions - HL7 Czech Terminology Implementation Guide v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://ncez.mzcr.cz/terminology/ValueSet/AllergenWithExceptions | *Version*:0.1.0 | |
...
* Import all the codes that are contained in [eHDSI Allergen No Drug](ValueSet-eHDSIAllergenNoDrug-cz.md)
* Import all the codes that are contained in [Léčivé přípravky](ValueSet-dlp-lecivepripravky.md)
* Import all the codes that are contained in [Český číselník ATC skupin](ValueSet-dlp-atc.md)
* Import all the codes that are contained in [eHDSI Absent Or Unknown Allergy](ValueSet-eHDSIAbsentOrUnknownAllergy-cz.md)
