# RoleCode (CZ Supplement) - HL7 Czech Terminology Implementation Guide v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.cz/terminology/CodeSystem/v3-RoleCode-cz | *Version*:0.1.0 |
...
This code system supplement `https://hl7.cz/terminology/CodeSystem/v3-RoleCode-cz` defines displays and properties on the following codes:
