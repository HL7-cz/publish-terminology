# Occupation of healthcare practitioner (CZ) - HL7 Czech Terminology Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Occupation of healthcare practitioner (CZ)**

## ValueSet: Occupation of healthcare practitioner (CZ) 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://ncez.mzcr.cz/terminology/ValueSet/nrzp-povolani-vs | *Version*:0.1.0 | |
| *Standards status:*[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 2 | *Computable Name*:NRZP_PovolaniVS |
...
* Include all codes defined in [`https://ncez.mzcr.cz/terminology/CodeSystem/nrzp-povolani`](CodeSystem-nrzp-povolani.md)version 📦0.1.0
