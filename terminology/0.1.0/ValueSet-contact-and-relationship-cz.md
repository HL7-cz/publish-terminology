# Contact and Relationship (CZ) - HL7 Czech Terminology Implementation Guide v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.cz/terminology/ValueSet/contact-and-relationship-cz | *Version*:0.1.0 |
...
* Import all the codes that are contained in [Contact Role (CZ)](ValueSet-contactrole-cz.md)
* Import all the codes that are contained in [Role code (CZ)](ValueSet-personal-relationship-cz.md)
...
* [valueset Contact Role (CZ) v0.1.0 (ValueSet)](ValueSet-contactrole-cz.md)
* [valueset Role code (CZ) v0.1.0 (ValueSet)](ValueSet-personal-relationship-cz.md)
