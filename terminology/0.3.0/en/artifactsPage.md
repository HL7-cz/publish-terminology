# Terminologies - HL7 Czech Terminology Implementation Guide v0.3.0
...
| | |
| :--- | :--- |
| [NCLPMAT](CodeSystem-NCLPMAT.md) | Číselník materiálů pro laboratoře |
| [NCLPPOL Code System](CodeSystem-NCLPPOL.md) | Národní číselník laboratorních položek |
| [ORPHA vzácná onemocnění](CodeSystem-ORPHAdisease.md) | Nomenklatura vzácných onemocnění ORPHAcode, která je nezbytná pro zlepšení viditelnosti vzácných onemocnění ve zdravotnických a výzkumných informačních systémech. |
...
| [DLP Lecive latky](CodeSystem-dlp-lecivelatky.md) | DLP Lecive latky - Czech national code system for active drug substances. |
| [DLP Lecive pripravky](CodeSystem-dlp-lecivepripravky.md) | DLP Lecive pripravky - Czech national registry of the pharmaceutical products. |
...
| [Kódový systém MKN-10](CodeSystem-mkn-10.md) | Národní systém pro kódování diagnóz a zdravotních problémů odvozený od ICD-10 WHO. |
...
| [Kódový systém NahradyZaZdravotniPeci](CodeSystem-nzis-NahradyZaZdravotniPeci.md) | Kódový systém použitý v Národním registru hospitalizovaných (NRHOSP) pro kódování důvodů náhrady za zdravotní péči. |
| [OdbornostVZP](CodeSystem-nzis-OdbornostVZP.md) | Kódový systém smluvních odborností poskytovatele (VZP) |
...
| [ActCode (CZ supplement)](CodeSystem-v3-ActCode-cz.md) | This code system supplements v3 ActCode. |
...
| [VZP - smluvní odbornost pracovišť](CodeSystem-vzp-smluvni-odbornost.md) | Kódový systém VZP - smluvní odbornost pracovišť je využíván pro objednávání a vykazování/vyúčtování zdravotních služeb. |
...
| [Allergy Intolerance Category (CZ supplement value set)](ValueSet-allergy-intolerance-category-cz.md) | Category of an identified substance associated with allergies or intolerances. |
| [AllergyIntoleranceCriticality (CZ supplement value set)](ValueSet-allergy-intolerance-criticality-cz.md) | Estimate of the potential clinical harm, or seriousness, of a reaction to an identified substance. |
...
| [Types of species](ValueSet-cz-lab-species-type.md) | Types of animal species for non-human subjects |
...
| [eHDSI Absent Or Unknown Allergy](ValueSet-eHDSIAbsentOrUnknownAllergy.md) | The Value set is used to encode absent or unknown medical allergies. |
| [eHDSI Absent Or Unknown Device](ValueSet-eHDSIAbsentOrUnknownDevice.md) | The Value set is used to encode absent or unknown medical devices. |
| [eHDSI Allergen No Drug](ValueSet-eHDSIAllergenNoDrug.md) | The value set is used to code the patient's kind of adverse reactions against substance, food or drugs |
| [eHDSI Dose Form](ValueSet-eHDSIDoseForm.md) | eHDSIDoseForm |
| [eHDSI Exceptional Value](ValueSet-eHDSIExceptionalValue.md) | The Value Set is used to code exceptional values for the required binding in FHIR IGs |
| [eHDSI Reaction Allergy](ValueSet-eHDSIReactionAllergy.md) | Value Set is used to encode clinical manifestation of the allergic reaction. |
| [eHDSI Route of Administration](ValueSet-eHDSIRouteofAdministration.md) | eHDSIRouteofAdministration |
| [ValueSet of Health Insurance Company Code](ValueSet-healthInsuranceCompanyCode.md) | Číselník kódů zdravotních pojišťoven. |
| [ID Card URIs](ValueSet-idcard-uri.md) | A country specific URI for personal Id card numbers |
...
| [Medical Test Result Code](ValueSet-medical-test-code.md) | Medical test result codes. List of Medical test result codes containing LOINC, NCLP and Snomed CT. |
...
| [NCLPPOL Value Set](ValueSet-nclppol.md) | Číselník obsahující koncepty z kódového systému NCLPPOL. Národní číselník laboratorních položek |
...
| [Číselník NahradyZaZdravotniPeci](ValueSet-nzis-nahradyzazdravotnipeci.md) | Číselník obsahující koncepty z kódového systému NahradyZaZdravotniPeci. Číselník použitý v NRHOSP |
| [Číselník OdbornostVZP](ValueSet-nzis-odbornostvzp.md) | Číselník obsahující koncepty z kódového systému OdbornostVZP. Číselník použitý v elektronických žádankách a NSHNU. |
| [Číselník ORPHAcode vzácná onemocnění](ValueSet-orphanet-rare-diseases.md) | Číselník vzácných onemocnění ORPHACode |
| [Standard namespaces for passports](ValueSet-passport-NS.md) | Číselník jmenných prostorů pro pasy. (Passport namespaces.) |
| [Passport URIs](ValueSet-passport-uri.md) | A country specific URI for passport numbers |
...
| [Číselník VZP - smluvní odbornost pracovišť](ValueSet-vzp-smluvni-odbornost.md) | VZPSmluvniOdbornost |
